...
public record DetailsRawMaterialProductDto(Integer quantity, DetailsProductDto productDto,
                                           DetailsRawMaterialDto rawMaterialDto) {
    public DetailsRawMaterialProductDto(RawMaterialProduct rawMaterialProduct) {
        this(rawMaterialProduct.getQuantity(), new DetailsProductDto(rawMaterialProduct.getProduct()),
